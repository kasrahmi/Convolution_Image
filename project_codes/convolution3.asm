...
segment .data
    ...
    print_time_convolution:        db "Time calculating convlution in ms :", 0
...
asm_main:
    ...
    conv_end:   
        ...
        mov rdi, print_time_convolution
        call print_string
...
get_matrix:                                                 ; method for getting our matrix and make our convolution_matrix which is bigger than normal one
...
conv:
    ...
    sub r13, [numberConv]
    dec r13                                                 ; r13' = r13 - numberConv - 1
    mov eax, convolution_matrix[r13*4]                      ; load element with index r13 from convolution matrix in index r15 matrix_dot
    mov matrix_dot[r15*4], eax
    inc r13                                                 ; r13' = r13 - numberConv
    inc r15                                                 ; r15 = 1
    mov eax, convolution_matrix[r13*4]                      ; load element with index r13 from convolution matrix in index r15 matrix_dot
    mov matrix_dot[r15*4], eax 
    inc r13                                                 ; r13' = r13 - numberConv + 1
    inc r15                                                 ; r15 = 2
    mov eax, convolution_matrix[r13*4]                      ; load element with index r13 from convolution matrix in index r15 matrix_dot
    mov matrix_dot[r15*4], eax 
    dec r13
    ...
    dec r13
    sub r13, [numberConv]                                   ; reset r13 to its first value                  
    ...
    mov r12, 9                                              ; use r12 as number for the loop
    ...
    add r13, 2                                              ; add 2 to our counter
